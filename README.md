...
## Overview
Rialize measures file-touches within a folder across a day, measuring every 10 minutes. Rialize assumes that 'file-touched' equals 'work done' within each quarter hour of time. Therefore, when this 'touch data' is consolidated at the end of the day, Rialize will generate a report telling you which hours had 'work done' on `files touched', thereby generating a Daily Progress Report summarizing this information.
